                                        ...
                                        <div class="header-right d-flex justify-content-end align-items-center">
                                            ...
                                            <ul class="header-account d-none d-md-block">
                                                <li class="d-none d-md-inline-block pl-20">
                                                    <a href="{{ route('login') }}" data-toggle="tooltip" data-selector="true" data-placement="bottom" title="My Account" class="dark-black-color"><span><i class="far fa-user-circle"></i></span>{{ auth()->user()?->name }}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div><!-- /header-right -->
